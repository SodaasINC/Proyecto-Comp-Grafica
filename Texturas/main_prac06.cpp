...
void LoadTextures()
{
	//Ruta, 0 si no hay transparencia 1 si si, true si es primitiva y false si es modelo importado
	...
	t_civic = generateTextures("Texturas/CivicTex.jpg", 0, true);
	t_hallo = generateTextures("Texturas/halloween.png", 1, true);
	t_cubo = generateTextures("Texturas/halloween.png", 0, true);
...
void myData() {
	...
	GLfloat verticesCubo[] = {
		...
		-0.5f, -0.5f, 0.5f,		0.0f, 0.666f,	//V0 - Frontal
		0.5f, -0.5f, 0.5f,		0.0f, 0.333f,	//V1
		0.5f, 0.5f, 0.5f,		0.25f, 0.333f,	//V5
		-0.5f, -0.5f, 0.5f,		0.0f, 0.666f,	//V0
		-0.5f, 0.5f, 0.5f,		0.25f, 0.666f,	//V4
		0.5f, 0.5f, 0.5f,		0.25f, 0.333f,	//V5

		0.5f, -0.5f, -0.5f,		0.75f, 0.333f,//V2 - Trasera
		-0.5f, -0.5f, -0.5f,	0.75f, 0.666f,	//V3
		...
		-0.5f, -0.5f, 0.5f,		1.0f, 0.666f,	//V0 - Inf
		-0.5f, -0.5f, -0.5f,	0.75f, 0.666f,	//V3
		0.5f, -0.5f, -0.5f,		0.25f, 0.666f,	//V2
		-0.5f, -0.5f, 0.5f,		1.0f, 0.666f,	//V0
		0.5f, -0.5f, -0.5f,		0.25f, 0.666f,	//V2
		0.5f, -0.5f, 0.5f,		1.0f, 0.333f,	//V1
	};
...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		myShader.setMat4("model", modelOp);
		myShader.setVec3("aColor", 1.0f, 1.0f, 1.0f);
		glBindTexture(GL_TEXTURE_2D, t_hallo);
