...
/* ----------------  Práctica 6                 -----------*/
/*-----------------    2024-1   ---------------------------*/
/*------------- Alumno: Luis Joaquin Castro Serrato--------*/
/*------------- No. Cuenta: 314081119       ---------------*/
#include <Windows.h>
...
int main()
{
	...
	// load models
	// -----------
	Model casaHal("resources/objects/Brujas/CasaHall.obj");
	Model cubObs("resources/objects/Obs/obsi.obj");
	...
	Model rombo("resources/objects/Rombo/romb.obj");
	Model bricks("resources/objects/Ladrillo/Red_Brick.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		casaHal.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(90.0f, 0.0f, 80.0f));
		//model = glm::scale(model, glm::vec3(3.5f));
		staticShader.setMat4("model", model);
		cubObs.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(30.0f, 0.0f, 80.0f));
		//model = glm::scale(model, glm::vec3(3.5f));
		staticShader.setMat4("model", model);
		rombo.Draw(staticShader);

		model = glm::translate(glm::mat4(1.0f), glm::vec3(-30.0f, 0.0f, 80.0f));
		model = glm::scale(model, glm::vec3(90.5f));
		staticShader.setMat4("model", model);
		bricks.Draw(staticShader);
